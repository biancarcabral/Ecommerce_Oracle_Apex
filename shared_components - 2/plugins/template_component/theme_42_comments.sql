...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(121615560573959251)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1921501031718990969)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121616060323959254)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121616382440959255)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121616606203959256)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121616933883959257)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121617229252959258)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121621813869959270)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1921501031718990969)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121617551830959260)
,p_plugin_attribute_id=>wwv_flow_imp.id(121617229252959258)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121617939063959261)
,p_plugin_attribute_id=>wwv_flow_imp.id(121617229252959258)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121618382614959261)
,p_plugin_attribute_id=>wwv_flow_imp.id(121617229252959258)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121618790631959262)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121617229252959258)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121619081654959263)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121619399680959263)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121619688400959264)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121619962632959265)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121621486653959269)
,p_plugin_attribute_id=>wwv_flow_imp.id(121619962632959265)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121620241680959266)
,p_plugin_attribute_id=>wwv_flow_imp.id(121619962632959265)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121620678170959267)
,p_plugin_attribute_id=>wwv_flow_imp.id(121619962632959265)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121621033811959268)
,p_plugin_attribute_id=>wwv_flow_imp.id(121619962632959265)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121621813869959270)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121622150731959270)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121622438270959272)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121622771256959272)
,p_plugin_attribute_id=>wwv_flow_imp.id(121622438270959272)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121623174027959273)
,p_plugin_attribute_id=>wwv_flow_imp.id(121622438270959272)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121623577870959274)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1921633699152092472)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921633107647085015)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921688731317066894)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921840949029937665)
,p_plugin_id=>wwv_flow_imp.id(121615560573959251)
