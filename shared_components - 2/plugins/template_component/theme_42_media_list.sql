...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(121625667447959287)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1921644058971842939)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1921643503959842938)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121626377641959292)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121626610153959293)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121626948886959293)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121627284290959294)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121627556491959295)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121626948886959293)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1921644058971842939)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121627854234959296)
,p_plugin_attribute_id=>wwv_flow_imp.id(121627556491959295)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121628245883959296)
,p_plugin_attribute_id=>wwv_flow_imp.id(121627556491959295)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121628655995959297)
,p_plugin_attribute_id=>wwv_flow_imp.id(121627556491959295)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121629098607959298)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121627556491959295)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121629318018959298)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121629608351959299)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121629954253959300)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121630295026959300)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121630557829959301)
,p_plugin_attribute_id=>wwv_flow_imp.id(121630295026959300)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121630914005959302)
,p_plugin_attribute_id=>wwv_flow_imp.id(121630295026959300)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121631308826959302)
,p_plugin_attribute_id=>wwv_flow_imp.id(121630295026959300)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121631757039959303)
,p_plugin_attribute_id=>wwv_flow_imp.id(121630295026959300)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121632170477959303)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(121627284290959294)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1921643503959842938)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121632436459959304)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121632727176959305)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121633047375959305)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121633340778959306)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121633615222959307)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121633930232959307)
,p_plugin_attribute_id=>wwv_flow_imp.id(121633615222959307)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121634300553959308)
,p_plugin_attribute_id=>wwv_flow_imp.id(121633615222959307)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121634730970959309)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121635084797959309)
,p_plugin_attribute_id=>wwv_flow_imp.id(121634730970959309)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121635432828959310)
,p_plugin_attribute_id=>wwv_flow_imp.id(121634730970959309)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121635895467959311)
,p_plugin_attribute_id=>wwv_flow_imp.id(121634730970959309)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121636281637959312)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121636520827959313)
,p_plugin_attribute_id=>wwv_flow_imp.id(121636281637959312)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121636958231959313)
,p_plugin_attribute_id=>wwv_flow_imp.id(121636281637959312)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121637310065959314)
,p_plugin_attribute_id=>wwv_flow_imp.id(121636281637959312)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121637797361959314)
,p_plugin_attribute_id=>wwv_flow_imp.id(121636281637959312)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121638124400959315)
,p_plugin_attribute_id=>wwv_flow_imp.id(121636281637959312)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121638598535959316)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121638833627959317)
,p_plugin_attribute_id=>wwv_flow_imp.id(121638598535959316)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121639286047959317)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921847111128989567)
,p_plugin_id=>wwv_flow_imp.id(121625667447959287)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
