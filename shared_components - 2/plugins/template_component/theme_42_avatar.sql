...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(121597677480959185)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121597983257959193)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121598257981959197)
,p_plugin_attribute_id=>wwv_flow_imp.id(121597983257959193)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121598632462959197)
,p_plugin_attribute_id=>wwv_flow_imp.id(121597983257959193)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121599032124959198)
,p_plugin_attribute_id=>wwv_flow_imp.id(121597983257959193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121599431426959199)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121597983257959193)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121599710587959200)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121600043293959201)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121600350461959202)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121600669845959204)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121600943554959204)
,p_plugin_attribute_id=>wwv_flow_imp.id(121600669845959204)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121601359181959205)
,p_plugin_attribute_id=>wwv_flow_imp.id(121600669845959204)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121601761302959206)
,p_plugin_attribute_id=>wwv_flow_imp.id(121600669845959204)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121602133103959207)
,p_plugin_attribute_id=>wwv_flow_imp.id(121600669845959204)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121602567741959208)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121602858536959209)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121603220500959210)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121603652021959211)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121604078546959211)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121604451654959212)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121604823017959213)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121605261748959213)
,p_plugin_attribute_id=>wwv_flow_imp.id(121602567741959208)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121605650663959214)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1921648556926072940)
,p_plugin_id=>wwv_flow_imp.id(121597677480959185)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
