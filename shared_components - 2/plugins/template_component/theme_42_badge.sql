...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(121606790249959226)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121607088772959229)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121607342376959229)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121607675215959230)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121607921216959231)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121608242750959232)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121608537007959232)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121608874627959233)
,p_plugin_attribute_id=>wwv_flow_imp.id(121608537007959232)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121609279062959234)
,p_plugin_attribute_id=>wwv_flow_imp.id(121608537007959232)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121609688739959235)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121609911521959235)
,p_plugin_attribute_id=>wwv_flow_imp.id(121609688739959235)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121610390243959236)
,p_plugin_attribute_id=>wwv_flow_imp.id(121609688739959235)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121610753207959236)
,p_plugin_attribute_id=>wwv_flow_imp.id(121609688739959235)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121611120484959237)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121611414805959238)
,p_plugin_attribute_id=>wwv_flow_imp.id(121611120484959237)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121611882217959239)
,p_plugin_attribute_id=>wwv_flow_imp.id(121611120484959237)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121612200314959239)
,p_plugin_attribute_id=>wwv_flow_imp.id(121611120484959237)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1633089034300061417)
,p_plugin_id=>wwv_flow_imp.id(121606790249959226)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
