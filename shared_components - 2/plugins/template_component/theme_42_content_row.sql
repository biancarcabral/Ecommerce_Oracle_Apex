...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(121657329144959386)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2048895200225031085)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2048894645213031084)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1792002581482757571)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121658283016959393)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121658517154959394)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121658837711959395)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121659153178959396)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121659459669959397)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121659703793959398)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121660031055959398)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121659459669959397)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2048895200225031085)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121660322652959399)
,p_plugin_attribute_id=>wwv_flow_imp.id(121660031055959398)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121660704536959399)
,p_plugin_attribute_id=>wwv_flow_imp.id(121660031055959398)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121661194577959400)
,p_plugin_attribute_id=>wwv_flow_imp.id(121660031055959398)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121661532799959401)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(121660031055959398)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121661834183959402)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121662106493959402)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121662476785959403)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121662789864959404)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121663066992959405)
,p_plugin_attribute_id=>wwv_flow_imp.id(121662789864959404)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121663456228959405)
,p_plugin_attribute_id=>wwv_flow_imp.id(121662789864959404)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121663887494959406)
,p_plugin_attribute_id=>wwv_flow_imp.id(121662789864959404)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121664223957959407)
,p_plugin_attribute_id=>wwv_flow_imp.id(121662789864959404)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121664654628959408)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(121659703793959398)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2048894645213031084)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121664943721959408)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121665271887959409)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121665576493959410)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121665882761959410)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121666180166959411)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121666469890959411)
,p_plugin_attribute_id=>wwv_flow_imp.id(121666180166959411)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121666866731959414)
,p_plugin_attribute_id=>wwv_flow_imp.id(121666180166959411)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121667257646959415)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121667581008959416)
,p_plugin_attribute_id=>wwv_flow_imp.id(121667257646959415)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121667903504959417)
,p_plugin_attribute_id=>wwv_flow_imp.id(121667257646959415)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121668343743959418)
,p_plugin_attribute_id=>wwv_flow_imp.id(121667257646959415)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121668739223959419)
,p_plugin_attribute_id=>wwv_flow_imp.id(121667257646959415)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121669159300959420)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121669491936959421)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121669817214959421)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121670264550959422)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121670676111959423)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121671046004959424)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121671494950959425)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121671838914959425)
,p_plugin_attribute_id=>wwv_flow_imp.id(121669159300959420)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121672223185959426)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121672500688959426)
,p_plugin_attribute_id=>wwv_flow_imp.id(121672223185959426)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121672929354959427)
,p_plugin_attribute_id=>wwv_flow_imp.id(121672223185959426)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121673363851959428)
,p_plugin_attribute_id=>wwv_flow_imp.id(121672223185959426)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121673749311959429)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121674023144959430)
,p_plugin_attribute_id=>wwv_flow_imp.id(121673749311959429)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121674411565959430)
,p_plugin_attribute_id=>wwv_flow_imp.id(121673749311959429)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121674852529959431)
,p_plugin_attribute_id=>wwv_flow_imp.id(121673749311959429)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121675216171959432)
,p_plugin_attribute_id=>wwv_flow_imp.id(121673749311959429)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121675662436959432)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121675986421959434)
,p_plugin_attribute_id=>wwv_flow_imp.id(121675662436959432)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121676356689959435)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121676641446959435)
,p_plugin_attribute_id=>wwv_flow_imp.id(121676356689959435)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121677032100959436)
,p_plugin_attribute_id=>wwv_flow_imp.id(121676356689959435)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121677435482959437)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121677778637959437)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121678008234959438)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1792002581482757571)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121678392310959438)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(121678685962959439)
,p_plugin_attribute_id=>wwv_flow_imp.id(121678392310959438)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121679065104959439)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(121679343752959440)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1930109090440852699)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1930110349960856847)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1633157575545094269)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1916515461766445966)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1917194762496529070)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1930107155373807713)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1930108488763821570)
,p_plugin_id=>wwv_flow_imp.id(121657329144959386)
