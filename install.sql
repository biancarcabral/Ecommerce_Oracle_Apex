...
@@application/shared_components/navigation/lists/fazer_a_compra.sql
...
@@application/shared_components/files/coffeeshopheader_jpg.sql
@@application/plugin_settings.sql
@@application/shared_components/security/authorizations/administration_rights.sql
@@application/shared_components/security/authorizations/cliente.sql
@@application/shared_components/security/authorizations/administrador.sql
@@application/shared_components/security/authorizations/gestor_de_pedidos.sql
@@application/shared_components/security/authorizations/estoquista.sql
...
@@application/shared_components/security/app_access_control/cliente.sql
@@application/shared_components/security/app_access_control/administrador.sql
@@application/shared_components/security/app_access_control/gestor_de_pedidos.sql
@@application/shared_components/security/app_access_control/estoquista.sql
@@application/shared_components/security/app_access_control/administrator_apex.sql
...
@@application/shared_components/logic/application_processes/initialize_shopping_cart_header.sql
@@application/shared_components/logic/application_items/shopping_cart_icon.sql
@@application/shared_components/logic/application_items/shopping_cart_items.sql
@@application/shared_components/logic/application_settings.sql
@@application/shared_components/navigation/tabs/standard.sql
@@application/shared_components/navigation/tabs/parent.sql
@@application/shared_components/user_interface/lovs/access_roles.sql
@@application/shared_components/user_interface/lovs/bianca_categorias_nome.sql
@@application/shared_components/user_interface/lovs/bianca_pedidos_usuario_id.sql
@@application/shared_components/user_interface/lovs/bianca_produtos_nome.sql
@@application/shared_components/user_interface/lovs/email_username_format.sql
@@application/shared_components/user_interface/lovs/lov_metodo_pagamento.sql
