...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(137863723282547596)
,p_lov_name=>'VIEW_AS_REPORT_CHART'
,p_lov_query=>'.'||wwv_flow_imp.id(137863723282547596)||'.'
,p_location=>'STATIC'
,p_version_scn=>44319103433870
);
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(137864024271547596)
...
wwv_flow_imp_shared.create_static_lov_data(
 p_id=>wwv_flow_imp.id(137864411826547597)
