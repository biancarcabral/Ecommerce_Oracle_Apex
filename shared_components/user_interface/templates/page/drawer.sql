...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121419562625959024)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121419861362959030)
,p_page_template_id=>wwv_flow_imp.id(121419562625959024)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121420189009959031)
,p_page_template_id=>wwv_flow_imp.id(121419562625959024)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121420420933959031)
,p_page_template_id=>wwv_flow_imp.id(121419562625959024)
