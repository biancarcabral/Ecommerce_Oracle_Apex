...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121426163460959041)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121426420455959041)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121426778308959041)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121427053037959041)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121427303909959041)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121427641719959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121427979995959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121428217918959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121428572139959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121428843162959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121429118966959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121429465002959042)
,p_page_template_id=>wwv_flow_imp.id(121426163460959041)
