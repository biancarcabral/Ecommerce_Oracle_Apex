...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121435386983959046)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121435663950959046)
,p_page_template_id=>wwv_flow_imp.id(121435386983959046)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121435953607959047)
,p_page_template_id=>wwv_flow_imp.id(121435386983959046)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121436216492959047)
,p_page_template_id=>wwv_flow_imp.id(121435386983959046)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121436562155959047)
,p_page_template_id=>wwv_flow_imp.id(121435386983959046)
,p_name=>'Body Footer'
