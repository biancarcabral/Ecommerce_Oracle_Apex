...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121445332594959054)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121445672701959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121445958823959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121446279425959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121446587649959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121446831257959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121447166243959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121447496915959055)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121447764969959056)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121448021416959056)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121448316566959056)
,p_page_template_id=>wwv_flow_imp.id(121445332594959054)
