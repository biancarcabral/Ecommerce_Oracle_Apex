...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121441991729959052)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121442275831959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121442582354959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121442811400959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121443170454959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121443409952959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121443754722959053)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121444047382959054)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121444341631959054)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121444672193959054)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121444908065959054)
,p_page_template_id=>wwv_flow_imp.id(121441991729959052)
