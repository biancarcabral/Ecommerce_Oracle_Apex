...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(121422462284959038)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121422755083959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121423085293959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121423394498959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121423629781959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121423959733959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121424210151959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121424504491959039)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121424849369959040)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121425175535959040)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121425489916959040)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121425759771959040)
,p_page_template_id=>wwv_flow_imp.id(121422462284959038)
