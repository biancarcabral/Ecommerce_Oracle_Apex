...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121482486292959079)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121482767730959080)
,p_plug_template_id=>wwv_flow_imp.id(121482486292959079)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121483062779959080)
,p_plug_template_id=>wwv_flow_imp.id(121482486292959079)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121483364863959080)
,p_plug_template_id=>wwv_flow_imp.id(121482486292959079)
,p_name=>'Sub Regions'
