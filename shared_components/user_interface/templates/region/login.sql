...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121516820970959100)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121517186143959100)
,p_plug_template_id=>wwv_flow_imp.id(121516820970959100)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121517484205959100)
,p_plug_template_id=>wwv_flow_imp.id(121516820970959100)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121517796096959100)
,p_plug_template_id=>wwv_flow_imp.id(121516820970959100)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121518035688959100)
,p_plug_template_id=>wwv_flow_imp.id(121516820970959100)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121518335016959100)
,p_plug_template_id=>wwv_flow_imp.id(121516820970959100)
,p_name=>'Sub Regions'
