...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121473776496959075)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121474079950959075)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121474393267959075)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121474661869959075)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121474945831959075)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121475262044959075)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121475534467959076)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121475852853959076)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121476124900959076)
,p_plug_template_id=>wwv_flow_imp.id(121473776496959075)
,p_name=>'Sub Regions'
