...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121488917959959083)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121489272285959084)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121489558072959084)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121489843203959084)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121490183332959084)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121490471941959084)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121490774539959085)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121491046863959085)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121491301949959085)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121491676210959085)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121491943338959085)
,p_plug_template_id=>wwv_flow_imp.id(121488917959959083)
,p_name=>'Sub Regions'
