...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121456815532959064)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121457100434959065)
,p_plug_template_id=>wwv_flow_imp.id(121456815532959064)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121457479841959065)
,p_plug_template_id=>wwv_flow_imp.id(121456815532959064)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121457790203959065)
,p_plug_template_id=>wwv_flow_imp.id(121456815532959064)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121458040229959065)
,p_plug_template_id=>wwv_flow_imp.id(121456815532959064)
,p_name=>'Sub Regions'
