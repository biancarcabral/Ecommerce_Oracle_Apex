...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121539572019959113)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121539881741959114)
,p_plug_template_id=>wwv_flow_imp.id(121539572019959113)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121540177325959114)
,p_plug_template_id=>wwv_flow_imp.id(121539572019959113)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121540413617959114)
,p_plug_template_id=>wwv_flow_imp.id(121539572019959113)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121540738231959114)
,p_plug_template_id=>wwv_flow_imp.id(121539572019959113)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121541001889959114)
,p_plug_template_id=>wwv_flow_imp.id(121539572019959113)
