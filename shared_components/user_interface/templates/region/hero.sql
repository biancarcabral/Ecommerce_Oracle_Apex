...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121498782209959089)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121499051788959090)
,p_plug_template_id=>wwv_flow_imp.id(121498782209959089)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121499325899959090)
,p_plug_template_id=>wwv_flow_imp.id(121498782209959089)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121499658396959090)
,p_plug_template_id=>wwv_flow_imp.id(121498782209959089)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121499948355959090)
,p_plug_template_id=>wwv_flow_imp.id(121498782209959089)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121500204202959090)
,p_plug_template_id=>wwv_flow_imp.id(121498782209959089)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
