...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121468328147959072)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121468652486959072)
,p_plug_template_id=>wwv_flow_imp.id(121468328147959072)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121468909260959072)
,p_plug_template_id=>wwv_flow_imp.id(121468328147959072)
,p_name=>'Sub Regions'
