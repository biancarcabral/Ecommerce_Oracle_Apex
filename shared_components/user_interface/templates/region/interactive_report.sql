...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121512275556959097)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121512536119959097)
,p_plug_template_id=>wwv_flow_imp.id(121512275556959097)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121512803680959097)
,p_plug_template_id=>wwv_flow_imp.id(121512275556959097)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121513157770959098)
,p_plug_template_id=>wwv_flow_imp.id(121512275556959097)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121513401310959098)
,p_plug_template_id=>wwv_flow_imp.id(121512275556959097)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121513729375959098)
,p_plug_template_id=>wwv_flow_imp.id(121512275556959097)
,p_name=>'Sub Regions'
