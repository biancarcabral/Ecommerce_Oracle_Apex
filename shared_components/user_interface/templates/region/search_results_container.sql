...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121519322245959101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121519668667959101)
,p_plug_template_id=>wwv_flow_imp.id(121519322245959101)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121519913677959101)
,p_plug_template_id=>wwv_flow_imp.id(121519322245959101)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121520232371959101)
,p_plug_template_id=>wwv_flow_imp.id(121519322245959101)
,p_name=>'Sub Regions'
