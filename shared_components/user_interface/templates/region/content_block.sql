...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121484331588959080)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121484617927959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121484911101959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121485224203959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121485536175959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121485878165959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121486156872959081)
,p_plug_template_id=>wwv_flow_imp.id(121484331588959080)
,p_name=>'Sub Regions'
