...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121450228252959058)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121450518549959060)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121450883741959061)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121451183424959061)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121451412915959061)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121451768281959061)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121452040856959061)
,p_plug_template_id=>wwv_flow_imp.id(121450228252959058)
,p_name=>'Sub Regions'
