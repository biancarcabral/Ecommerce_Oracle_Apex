...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121502241773959091)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121502502644959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121502867218959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121503117604959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121503451271959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121503798038959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121504055469959092)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121504356660959093)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121504680727959093)
,p_plug_template_id=>wwv_flow_imp.id(121502241773959091)
,p_name=>'Sub Regions'
