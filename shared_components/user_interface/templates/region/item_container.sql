...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121514334341959098)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121514684590959098)
,p_plug_template_id=>wwv_flow_imp.id(121514334341959098)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121514962238959099)
,p_plug_template_id=>wwv_flow_imp.id(121514334341959098)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121515245200959099)
,p_plug_template_id=>wwv_flow_imp.id(121514334341959098)
,p_name=>'Button Start'
