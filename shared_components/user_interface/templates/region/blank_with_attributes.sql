...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121455477595959063)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121455714295959064)
,p_plug_template_id=>wwv_flow_imp.id(121455477595959063)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121456058913959064)
,p_plug_template_id=>wwv_flow_imp.id(121455477595959063)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121456305190959064)
,p_plug_template_id=>wwv_flow_imp.id(121455477595959063)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121456601983959064)
,p_plug_template_id=>wwv_flow_imp.id(121455477595959063)
,p_name=>'Sub Regions'
