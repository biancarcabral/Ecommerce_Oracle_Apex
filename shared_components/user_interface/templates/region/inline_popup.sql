...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121506856088959094)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121507172694959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121507455223959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121507796600959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121508059667959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121508354784959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121508649106959095)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121508961335959096)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121509281841959096)
,p_plug_template_id=>wwv_flow_imp.id(121506856088959094)
,p_name=>'Sub Regions'
