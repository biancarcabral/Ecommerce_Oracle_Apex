...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121531889617959109)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121532147048959109)
,p_plug_template_id=>wwv_flow_imp.id(121531889617959109)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121532425787959109)
,p_plug_template_id=>wwv_flow_imp.id(121531889617959109)
,p_name=>'Tabs'
