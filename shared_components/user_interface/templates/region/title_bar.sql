...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(121534475801959110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121534724781959110)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121535062777959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121535337519959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121535690591959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121535932927959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121536278014959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121536548445959111)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121536867289959112)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121537152333959112)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121537455912959112)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121537769226959112)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121538043822959112)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(121538309945959113)
,p_plug_template_id=>wwv_flow_imp.id(121534475801959110)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
